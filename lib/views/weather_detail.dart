...
class _WeatherDetailState extends State<WeatherDetail> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return WeatherDetailPanel(
        ...
        hourly: List.generate(widget.hourlyTimes.length,
            (index) => TemperaturePill(selected: index == DateTime.now().hour, dateOrTime: widget.hourlyTimes[index], weatherCode: widget.hourlyWeatherCode[index], avgTemp: widget.hourlyTemp[index])),
